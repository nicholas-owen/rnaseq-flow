...
every tool used in a run is recorded in `pipeline_info/software_versions_mqc.yml`.
...
tool **versions** from `pipeline_info/software_versions_mqc.yml`.

> RNA-seq data were processed with the rnaseq-flow pipeline (v1.6.0), implemented
